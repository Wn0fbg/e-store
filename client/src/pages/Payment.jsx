...
const Payment = () => {
  ...
  const handlePlaceOrder = (e) => {
    ...
    formData.append("orderedItems", JSON.stringify());
            ...
            <div className="flex items-center justify-center mb-12">
              <div className="flex items-center space-x-4">
                ...
                >
                  ...
                  >
                    {orderStep > 1 ? <Check className="size-5" /> : "1"}
                  </div>
              ...
              <div className="lg:col-span-2">
                {orderStep === 1 ? (
                  ...
                  <form onSubmit={handlePlaceOrder} className="glass-panel">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        >
                          ...
                          <option value="Khyber PakhtunKwa (KPK)">
                    ...
                    <button
                      type="submit"
                      className={`w-full py-3 gradient-primary text-primary-foreground 
