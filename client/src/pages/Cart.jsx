    ...
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center">
        <div className="text-center glass-panel max-w-md">
          ...
          >
            <span>Continue shopping</span> <ArrowRight className="size-5" />
          </Link>
        </div>
      </div>
    );
                    ...
                    <div className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6">
                      ...
                      >
                        <img
                          ...
                          className="size-24 object-cover rounded-lg hover:scale-105 transition-transform"
                        />
                      </Link>

                      <div className="flex-1 min-w-0">
                        <Link
                          to={`/prodct/${item.product.id}`}
