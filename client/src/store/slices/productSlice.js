...
export const postRewiew = createAsyncThunk(
...
export const deleteRewiew = createAsyncThunk(
...
const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(postRewiew.fulfilled, (state) => {
