...
export const forgotPassoword = createAsyncThunk(
...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(forgotPassoword.pending, (state) => {
        state.isRequestingForToken = true;
      })
      .addCase(forgotPassoword.fulfilled, (state, action) => {
        state.isRequestingForToken = false;
      })
      .addCase(forgotPassoword.rejected, (state) => {
        state.isRequestingForToken = false;
      })
