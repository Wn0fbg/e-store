  ...
  return `
       <div 
         style="
           ...
           border: 1px solid #ddd; border-radius: 8px background-color: #000; 
           color: #fff
        ">
            <h2 style="color: #fff; text-aling: center;">Reset Your password</h2>
            ...
            <p style="font-size: 16px; color: #ccc">You requested to reset your password. Please click the button below to proceed:</p>
               ...
               <footer style="margin-top: 20px; text-aling: center; font-size: 14px; color: #666">
                 <p>Thank you, <br>Eccomerce Team</p>
